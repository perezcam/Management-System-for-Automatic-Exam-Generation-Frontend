...
export default function PruebasView() {
  ...
  const totalPages = Math.max(1, Math.ceil((total ?? exams.length) / (pageSize > 0 ? pageSize : 1)))
        ...
        <div className="max-w-7xl mx-auto w-full h-full px-4 sm:px-6 py-4 sm:py-6">
          {loading ? (
            ...
            <div className="h-full flex flex-col">
                    ...
                    return (
                      ...
                      >
                        <div className="space-y-4">
                          ...
                          {/* ✅ Botón alineado a la izquierda (sin "w-full") */}
                          {exam.status === AssignedExamStatus.ENABLED && (
                            <div className="pt-3 border-t flex justify-start">
                              <Button
                                onClick={(e) => {
                                  e.stopPropagation()
                                  handleExamClick(exam)
              ...
              {/* ✅ Paginación alineada (izquierda texto / derecha botones) */}
