...
export function ExamViewDialog({ open, onOpenChange, exam }: ExamViewDialogProps) {
  if (!exam) return null

  const isRejected = exam.status === "Rechazado"
  const isUnderReview = exam.status === "Bajo Revisión"
        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {isRejected 
              ...
              : isUnderReview 
              ? "Revisa el contenido del examen en revisión"
